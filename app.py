...
@app.route('/generate/<layout>/<page_size>/<int:numcards>', methods=['GET'])
def generate_bingo(layout, page_size, numcards):
    ...
    cards_data = {i + 1: (title, generate_bingo_numbers()) for i in range(numcards)}
